...
public class LaborerDialog extends AbstractWindowEditor {
	...
	public LaborerDialog(BeanItem<Laborer> item,ConstructionSite constructionSite, LaborerService service , VelocityEngine velocityEngine){
		super(item);
					...
					public Object generateCell(Table source, Object itemId, Object columnId) {
						...
						btnPrint.addClickListener(new Button.ClickListener() {
							...
							public void buttonClick(ClickEvent event) {
								...
								input.put("constructionSite", constructionSite);
								input.put("laborer", getItem().getBean());
